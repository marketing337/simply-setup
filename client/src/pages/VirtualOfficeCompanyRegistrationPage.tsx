...
export default function VirtualOfficeCompanyRegistrationPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Start Your Company — thegstco</title>
        <meta
          name="description"
          content="Fast company registration with expert support. Choose your structure, add GST/VPOB, and stay compliant from day one."
        />
      </Helmet>
